...
bk = Image ("images\\mobilebackground.jpg",game)
...
title = Image("images\\gamelogo.png",game)
bk.draw()
title.draw()
...
platform2 = Image("images\\platform.png",game)
x = 1200
y = randint(300,500)
...
platform3 = Image("images\\platform.png",game)
x = 1600
y = randint(300,500)
...
platform4 = Image("images\\platform.png",game)
x = 2000
y = randint(300,500)
...
car = Image("images\\greencar.png",game)
car.resizeBy(-75)


gascan = Image ("images\\gascan.png",game)
x = 700
y = randint(300, 500)
gascan.moveTo( x, 350 )
...
gamewin =  Image("images\\mmgamewin.png",game)


gameover =  Image("images\\mmgamelose.png",game)
